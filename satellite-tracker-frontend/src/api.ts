...
export async function getPrediction(
    ...
    if (!response.ok) {
        ...
        throw new Error(
            "Failed to fetch satellite prediction"
        );
...
: Promise<SatelliteGroups> {
    ...
    if (!response.ok) {
        ...
        throw new Error(
            "Failed to fetch satellite groups"
        );
...
export async function getSatelliteOrbits()
: Promise<SatelliteOrbits> {


    const response =
        await fetch(
            `${API_BASE}/satellites/orbits`
        );
    ...
    if (!response.ok) {
        ...
        throw new Error(
            "Failed to fetch satellite orbit regions"
        );
